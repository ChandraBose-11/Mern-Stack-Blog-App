      ...
      <div className="mx-auto w-full max-w-7xl p-4 md:py-8">
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/32x32/14b8a6/ffffff?text=BH";
                }} // Fallback
              />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 mt-4 sm:mt-0">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium space-y-2">
                <FooterLinkItem href="https://flowbite.com/" target="_blank">
                  Flowbite
                </FooterLinkItem>
                <FooterLinkItem href="https://tailwindcss.com/" target="_blank">
                  Tailwind CSS
                </FooterLinkItem>
                <FooterLinkItem href="https://reactjs.org/" target="_blank">
                  React
                </FooterLinkItem>
                <FooterLinkItem href="https://redux.js.org/" target="_blank">
                  Redux
                </FooterLinkItem>
                <FooterLinkItem
                ...
                <FooterLinkItem href="https://ant.design/" target="_blank">
                  Ant Design
                </FooterLinkItem>
                <FooterLinkItem
                ...
                <FooterLinkItem href="https://reactrouter.com/" target="_blank">
                  React Router DOM
                </FooterLinkItem>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium space-y-2">
                ...
                <FooterLinkItem
                  href="https://www.npmjs.com/package/react-circular-progressbar"
                  target="_blank"
                >
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium space-y-2">
                ...
                <FooterLinkItem href="https://expressjs.com/" target="_blank">
                  Express
                </FooterLinkItem>
                <FooterLinkItem href="https://mongoosejs.com/" target="_blank">
                  Mongoose
                </FooterLinkItem>
                <FooterLinkItem
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400 font-bold">
            ...
            Copyright {currentYear}. All Rights Reserved by ChandraBose™.
          </span>
