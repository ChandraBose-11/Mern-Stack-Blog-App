...
const DashProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ FIXED: added withCredentials: true so JWT cookie is sent
      const res = await axios.put(
        `https://mern-stack-blog-app-8.onrender.com/api/user/update/${currentUser._id}`,
        data,
        {
  ...
  const handleSignout = async () => {
    try {
      await fetch(
        `https://mern-stack-blog-app-8.onrender.com/api/user/signout`,
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://mern-stack-blog-app-8.onrender.com/api/user/delete/${currentUser._id}`,
        {
          method: "DELETE",
          credentials: "include",
        }
