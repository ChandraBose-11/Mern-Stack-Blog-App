...
const Postpage = () => {
  ...
  // ✅ Get currentUser from Redux and pass to CommentSection
    ...
    const fetchPost = async () => {
      try {
        ...
        const res = await fetch(
          `https://mern-stack-blog-app-server.onrender.com/api/post/getposts?slug=${postSlug}`,
           {
            method: "GET",
  ...
  useEffect(() => {
    const fetchRecentPosts = async () => {
      try {
        ...
        const res = await fetch(
          `https://mern-stack-blog-app-server.onrender.com/api/post/getposts?limit=4`,
          {
            method: "GET",
            credentials: "include", // 🔥 REQUIRED FIX
          }
  ...
  return (
    <main className="relative p-4 max-w-6xl mx-auto min-h-screen bg-white text-gray-800 dark:bg-[#0f172a] dark:text-gray-100 transition-colors duration-500">
      ...
      <div className="max-w-3xl mx-auto mb-12 border-t border-gray-300 pt-6 p-6 bg-gray-100 rounded-lg shadow-sm dark:bg-[#1e293b]">
        {/* ✅ Pass currentUser down so CommentSection can use it */}
